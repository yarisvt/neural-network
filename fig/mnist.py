...
def plot_rotated_image(image):
    ...
    for j in range(28):
        for k in range(28):
            ...
            if x2 < -13 or x2 > 13 or y2 < -13 or y2 > 13:
                continue
...
def load_data():
    ...
    training_set, validation_set, test_set = pickle.load(f, encoding='bytes')
    f.close()
